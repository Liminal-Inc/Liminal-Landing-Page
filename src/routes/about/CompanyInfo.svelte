...
<!-- Mission -->
<div class="col-span-4 outline-gray-600 outline rounded-lg text-xl">
	<p
...
<!-- Our Values -->
<div class="col-span-2 sm:col-span-1 outline-gray-600 outline rounded-lg mt-8">
	<p
		class="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold py-4 px-4 text-black text-center bg-purple-300"
	>
		Our Values
	...
	<div class="text-white text-lg">
		<div class="p-2">
			...
			<p>
				Science is nothing without communication, and neither is our company. Poor communication is
				at the core of most problems, so we strive to be open and honest with our clients and each
				other.
			</p>
		</div>
		...
		<div class="p-2">
			...
			<p>
				...
				The first and most important aspect of this is connecting the people in the lab and
				stimulating scientific discourse and collaboration.
			</p>
		</div>
		...
		<div class="p-2">
			...
			<p>
				Our software is a means to an end. We strive to be creative in our approach to solving
				problems, challenging current systems in place. Liminal communicates and connects the
				research ecosystem so the scientist has all the tools and objects they need to be creative.
			</p>
		</div>
	</div>
</div>
