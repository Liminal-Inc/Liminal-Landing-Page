...
<svelte:head>
	<title>LabKnowledge</title>
	<meta name="description" content="Generating lab knowledge in academic life science laboratories" />
</svelte:head>

<body>
    <div class="blog-post">
        <Button class="text-black font-bold bg-purple-300 hover:bg-gray-700" href="/"><ArrowLeftOutline/>Home</Button>
        <h1 class="text-purple-600 mb-4 text-4xl">Lab Knowledge Generation</h1>
        <div class="keywords">
            <span>data</span>, <span>information</span>, <span>knowledge</span>
        </div>
