...
<section class="min-h-screen bg-black text-white px-4 py-12">
	<div class="max-w-3xl mx-auto bg-white text-black p-8">
		<h1 class="text-3xl font-bold mb-6">Join Liminal</h1>

		<div class="aspect-video w-full">
			<!-- <iframe
				title="Sign up"
				src="https://docs.google.com/forms/d/e/1FAIpQLSd2gtATL3ifoL3cg_IBaxFpP96MhLZY2uy9zVTxOUwRiPcXwQ/viewform?embedded=true"
				width="640"
				height="2335"
				frameborder="0"
				marginheight="0"
